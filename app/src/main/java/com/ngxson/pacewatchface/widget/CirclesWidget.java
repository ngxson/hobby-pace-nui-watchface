...
import com.ngxson.pacewatchface.data.Battery;
import com.ngxson.pacewatchface.data.DataType;
import com.ngxson.pacewatchface.data.Steps;
import com.ngxson.pacewatchface.data.TodayDistance;
...
public class CirclesWidget extends AbstractWidget {
    ...
    public void init(Service service) {
        ...
        this.textPaint.setTypeface(ResourceManager.getTypeFace(service.getResources(), ResourceManager.Font.ROBOTO));
